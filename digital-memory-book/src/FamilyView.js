  ...
  return (
    <div style={pageStyles}>
      <div style={centerContentStyle}>
        <h2 className="Text">My Family View</h2>
        <p className="Text"> Your family code is: {code}</p>
        <button
        ...
        <div>
          <h3 className="Text">Family Members in the Timeline</h3>
        ...
        >
          ...
          <div>
            <button style={button} onClick={inviteMember}>
              Invite Member
            </button>
            <button style={button} onClick={closeInviteModal}>
              Cancel
            </button>
          </div>
        </Modal>
